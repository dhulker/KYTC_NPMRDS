...
with the following:
    (1) A truck travel time data set shall be created from the travel time data set to be used to calculate the TTTR metric. This data set shall include, for each reporting segment, a ranked list of average truck travel times, to the nearest second, for 15 minute periods of a 24-hour period for an entire calendar year that:
        ...
        (ii) Includes ‘‘Mid Day’’ travel times occurring between the hours of 10 a.m. and 4 p.m. for every weekday (MondayFriday) from January 1st through December 31st of the same year;
        ...
        (iv) Includes ‘‘Overnight’’ travel times occurring between the hours of 8 p.m. and 6 a.m. for every day (SundaySaturday) from January 1st through December 31st of the same year; and
